package com.mlefrapper.clean.ui.base
...
abstract class BaseViewModel(
    ...
    private fun CoroutineScope.launchOnIO(block: suspend CoroutineScope.() -> Unit): Job = launch(io, block = block)
    private fun CoroutineScope.launchOnMain(block: suspend CoroutineScope.() -> Unit): Job = launch(main, block = block)
    private fun CoroutineScope.launchOnMainImmediate(block: suspend CoroutineScope.() -> Unit): Job = launch(mainImmediate, block = block)
