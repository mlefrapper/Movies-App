package com.mlefrapper.clean.ui.theme
...
private val darkColors = darkColorScheme(
    primary = AppColor.DarkGray, // Main Primary Color
    ...
    background = AppColor.DarkGray, // Background color used for the app's screens

    surface = AppColor.DarkGray, // Background color used in components like the NavigationBar and TopAppBar
    onSurface = Color.White, // For example, selected text in NavigationBar

    surfaceVariant = AppColor.DarkGray, // Used in TextField, SearchView
